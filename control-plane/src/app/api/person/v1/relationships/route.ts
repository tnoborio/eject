...
import { handleAcceptRelationshipInvitation } from "@/modules/permissions/transport/person-relationship-http-handlers";
...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    return await handleAcceptRelationshipInvitation(
      request,
